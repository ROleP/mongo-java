...
public class BlogPostDAO {
    ...
    public void likePost(final String permalink, final int ordinal) {
        ...
        //
        //
        String commentNum = "comments." + ordinal + ".num_likes";
        Document like = new Document("$inc", new Document(commentNum, 1));
        postsCollection.updateOne(eq("permalink", permalink), like, new UpdateOptions().upsert(true));
    }
}
